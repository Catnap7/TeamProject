...
<body>
<h1 class="terms_h1">왓츄 개인정보처리방침 </h1>
 <div class="terms_div">
본 방침은 2018년 3월 30일부터 적용됩니다. 
 
총칙 
주식회사 왓츄는(이하 ‘회사’라고 합니다)는 왓츄(Watchu), 왓츄(WATCHU) 및 왓챠 관련 제반 서비스(이하 “서비스”라고 합니다)를 이용하는 회원의 개인정보 보호를 소중하게 생각하고, 회원의 개인정보를 보호하기 위하여 항상 최선을 다해 노력하고 있습니다.<br> 
...
본 개인정보취급방침은 왓츄, 왓츄플레이 및 왓챠 관련 제반 서비스를 이용하는 회원에 대하여 적용되며, 회원에 대하여 적용되며, 회원이 제공하는 개인정보가 어떠한 용도와 방식으로 이용되고 있으며, 개인정보 보호를 위하여 어떠한 조처를 취하고 있는지 알립니다.<br> 
 <br>
개인정보의 수집·이용에 대한 동의<br> 
회사에서 적법하고 공정한 방법에 의하여 서비스 이용계약의 성립 및 이행에 필요한 최소한의 개인정보를 수집하며 이용자의 개인 식별이 가능한 개인정보를 수집하기 위하여 회원가입시 개인정보수집·이용 동의에 대한 내용을 제공하고 회원이 '동의' 버튼을 클릭하면 개인정보 수집·이용에 대해 동의한 것으로 봅니다.<br> 
 <br>
 <hr class="terms_hr">
...
3. 회사는 회원이 이벤트, 프로모션에 참여하는 경우 아래의 정보를 수집할 수 있습니다. <br>
- 이름, 이메일 주소, 휴대전화번호, 주소, 생년월일 <br>
4. 서비스 이용과정에서 아래와 같은 정보들이 생성되어 수집될 수 있습니다.<br> 
(1) PC : PC MacAddress, PC 사양정보, 브라우저 정보, 기타 서비스 이용 시 사용되는 프로그램 버전 정보<br> 
(2) 휴대전화(스마트폰) & 스마트OS 탑재 모바일 기기(Tablet PC 등) : 모델명, 기기별 고유번호(UDID,IMEI 등), OS정보, 이동통신사, 구글/애플 광고 ID<br> 
(3) 기타 정보 : 서비스 이용(정지) 기록, 접속 로그, 쿠키, 접속 IP정보 <br>
5. 회사는 다음과 같은 방식으로 개인정보를 수집합니다. <br>
(1) 홈페이지 이용 및 서면양식, 상담 게시판, 경품 행사 응모, 배송요청<br> 
(2) 제휴 회사로부터의 제공 <br>
(3) 생성정보 수집툴을 통한 수집 <br>
...
- (주) KG 이니시스: 신용카드를 통한 결제 대행 <br>
- NICE 신용평가 : 휴대폰, I-pin 사용자 본인인증 <br>
 <br>
 <hr class="terms_hr">
...
(4) 금융실명거래및비밀보장에관한법률, 신용정보의이용및보호에관한법률, 전기통신기본법, 전기통신사업법, 지방 세법, 소비자보호법, 한국은행법, 형사소송법 등 기타 관계법령에서 정한 절차에 따른 요청이 있는 경우 <br>
